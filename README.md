# streakeeper
1. The goal of the project is to allow the user to make good on a skill or habit that the user chooses by gamifying the process by trying to form a streak akin to an app like Duolingo. 
...
3. My motivation is that i wish there was such an app that is like this for me to be able to gamify making progress on learning guitar because i personally struggle with putting in a consistent efforft for things i want to do.
...
-- be more specific in my motivation
--  make it so the skill you want to learn can be changed